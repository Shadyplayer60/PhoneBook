...
namespace PhoneBook {
    ...
    public partial class PersonDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(int PersonID, string Name, string Phone_Number) {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([PersonID] = @Original_PersonID) AND ([Name] =" +
                " @Original_Name) AND ([Phone Number] = @Original_Phone_Number))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([PersonID], [Name], [Phone Number]) VALUES (@PersonID" +
                ", @Name, @Phone_Number);\r\nSELECT PersonID, Name, [Phone Number] FROM Person WHER" +
                "E (PersonID = @PersonID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [PersonID] = @PersonID, [Name] = @Name, [Phone Number] = @Phone_Number WHERE (([PersonID] = @Original_PersonID) AND ([Name] = @Original_Name) AND ([Phone Number] = @Original_Phone_Number));
SELECT PersonID, Name, [Phone Number] FROM Person WHERE (PersonID = @PersonID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PersonID, Name, [Phone Number] FROM dbo.Person";
        ...
        public virtual int Delete(int Original_PersonID, string Original_Name, string Original_Phone_Number) {
        ...
        public virtual int Insert(int PersonID, string Name, string Phone_Number) {
        ...
        public virtual int Update(int PersonID, string Name, string Phone_Number, int Original_PersonID, string Original_Name, string Original_Phone_Number) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone_Number, int Original_PersonID, string Original_Name, string Original_Phone_Number) {
            return this.Update(Original_PersonID, Name, Phone_Number, Original_PersonID, Original_Name, Original_Phone_Number);
        }
    }
